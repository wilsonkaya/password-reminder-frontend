...
/***/ function(module, exports, __webpack_require__) {
	...
	var accountEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  }).then(ui.success).catch(function (error) {
	...
	var closeChagngePasword = function closeChagngePasword() {
	  $("#warning1").text("");
	  $("#warning2").text("");
	  $("#warning3").text("");
	  $(".clean-changepassword").val("");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// button is clicked
	var onGetAccount = function onGetAccount(event) {
	  event.preventDefault();
	  api.index().then(ui.onSuccess).catch(ui.onError);
	};
	...
	var onDeleteAccount = function onDeleteAccount(event) {
	  ...
	  api.destroy(accountId).then(ui.onDeleteSuccess(accountId)).catch(ui.onError);
	};
	//
	var onPatchAccount = function onPatchAccount(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var accountId = event.target.getAttribute('data-id');
	  // console.log(data,accountId);
	  api.patch(data, accountId).then(ui.onPatchSuccess(data, accountId)).catch(ui.onError);
	};

	var onPostAccount = function onPostAccount(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.post(data).then(ui.onPostSuccess).catch(ui.onPostError);
	};

	var accountHandlers = function accountHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patch = function patch(data, accountId) {
	  return $.ajax({
	    url: config.apiOrigin + '/accounts/' + accountId,
	    method: "PATCH",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showBooksTemplate = __webpack_require__(15);
	var createAccount = __webpack_require__(35);
	var updateAccount = __webpack_require__(36);
	// const logic = require("../programlogic.js");
	var onSuccess = function onSuccess(data) {
	  if (data.accounts.length === 0) {
	    $("#warning-get").html('<p class="blink_me"> NO DATA! </p>');
	  } else {
	    var showBooksHtml = showBooksTemplate({ accounts: data.accounts });
	...
	var onDeleteSuccess = function onDeleteSuccess(accountId) {
	  $('[data-id =' + accountId + ']').remove();
	};

	var onPatchSuccess = function onPatchSuccess(data, accountId) {
	  $(".warning-update-data").text("Succesfull !");
	  setTimeout(function () {
	    $('.kapat').modal('hide');
	  }, 1250);
	  setTimeout(function () {
	    $('.warning-update-data').text("");
	  }, 1250);
	  // console.log(accountId)
	  var showBooksHtml = updateAccount({ account: data.account, accountId: accountId });
	...
	var onPostSuccess = function onPostSuccess(data) {
	  ...
	  setTimeout(function () {
	    $('#myModal-create-password').modal('hide');
	  }, 1300);
	  setTimeout(function () {
	    $('.clean-create').val("");
	  }, 1300);
	  setTimeout(function () {
	    $('#warning-create-new-data').text("");
	  }, 1300);
	  var showBooksHtml = createAccount({ account: data.account });
	  $('.content').append(showBooksHtml);
	  $("#warning-get").text("");
	};

	var onPostError = function onPostError() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n   <div class=\"jumbotron\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n     <h3>Web Name</h3>\n     <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.web_name : stack1), depth0))
	    + "</p>\n     <h3>Password Hint</h3>\n     <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.password_hint : stack1), depth0))
	    + "</p>\n\n     <!-- Button trigger modal -->\n     <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#mod"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n       Update!\n     </button>\n\n     <!-- Modal -->\n     <div class=\"modal fade kapat\" id=\"mod"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n       <div class=\"modal-dialog\" role=\"document\">\n         <div class=\"modal-content\">\n           <div class=\"modal-header\">\n             <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n             <h4 class=\"modal-title\" id=\"myModalLabel\">Update!</h4>\n           </div>\n           <div class=\"modal-body\">\n             <form class=\"submit-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                 <input type=\"text\" name=\"account[web_name]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.web_name : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"text\" name=\"account[password_hint]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.password_hint : stack1), depth0))
	    + "\" class=\"clean-update\">\n                 <input type=\"submit\" name=\"submit\">\n             </form>\n             <div class=\"warning-update-data\">\n\n             </div>\n           </div>\n           <div class=\"modal-footer\">\n             <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n           </div>\n         </div>\n       </div>\n     </div>\n\n\n     <button type=\"button\" name=\"button\" class=\"btn btn-default remove\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button>\n   </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.accounts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"jumbotron\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <h3>Web Name</h3>\n  <p>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.web_name : stack1), depth0))
	    + "</p>\n  <h3>Password Hint</h3>\n  <p>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.password_hint : stack1), depth0))
	    + "</p>\n\n  <!-- Button trigger modal -->\n  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#mod"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n       Update!\n     </button>\n\n  <!-- Modal -->\n  <div class=\"modal fade kapat\" id=\"mod"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.id : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"jumbotron\" data-id=\""
	    ...
	    + "\">\n  <h3>Web Name</h3>\n  <p>"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.web_name : stack1), depth0))
	    + "</p>\n  <h3>Password Hint</h3>\n  <p>"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.account : depth0)) != null ? stack1.password_hint : stack1), depth0))
	    + "</p>\n  <!-- Button trigger modal -->\n  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#mod"
	    + alias4(((helper = (helper = helpers.accountId || (depth0 != null ? depth0.accountId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"accountId","hash":{},"data":data}) : helper)))
	    + "\">\n       Update!\n     </button>\n\n  <!-- Modal -->\n  <div class=\"modal fade kapat\" id=\"mod"
	    + alias4(((helper = (helper = helpers.accountId || (depth0 != null ? depth0.accountId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"accountId","hash":{},"data":data}) : helper)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "17b0eedfe8d583f58182f20165d6ec97.jpg";
